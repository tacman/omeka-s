...
class ProxyFactory extends AbstractProxyFactory
{
     ...
     * @var integer
     */
    public const AUTOGENERATE_AUTOLOAD = -1;
...
EOPHP;
    ...
    public function __construct(EntityManagerInterface $em, $proxyDir, $proxyNs, $autoGenerate = self::AUTOGENERATE_NEVER)
    {
        ...
        if (is_int($autoGenerate) ? $autoGenerate < -1 || $autoGenerate > 4 : ! is_bool($autoGenerate)) {
    ...
    private function loadProxyClass(ClassMetadata $class): string
    {
        ...
        if ($this->autoGenerate === self::AUTOGENERATE_AUTOLOAD) {
